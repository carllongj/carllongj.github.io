...
* **《深入理解Java虚拟机》**
## 一丶代理模式
  代理模式是一种比较常见的设计模式,用过Spring的开发者应该知道Spring的核心之一是AOP,而AOP使用的就是代理.下面的图是wiki百科对代理模式的类图![W3sDesign_Proxy_Design_Pattern_UMLjpg](http://carllongj-picture-upload.oss-cn-hangzhou.aliyuncs.com/file/2019/05/927ec522a81e4b42937fea51ab1084fc_W3sDesign_Proxy_Design_Pattern_UML.jpg) 
...
## 五丶参考
* [代理模式-维基百科](https://en.wikipedia.org/wiki/Proxy_pattern)','/articles/2019/05/04/1556969777160.html','1','1','0',1557462979262,1557462979262,0.7836574396927796,'1','1','','CodeMirror-Markdown'),('1557309919348','Java中实现泛型的类型擦除','','java,编译,字节码,泛型','1547133780154',0,0,'![](https://img.hacpai.com/bing/20190427.jpg?imageView2/1/w/960/h/520/interlace/1/q/100)
